...
class DatabasenameValueTest extends TestCase
{
    ...
    {
        $this->validator = $this->getMockBuilder(DatabasenameValidator::class)
    ...
    public function testToString(): void
    {
        ...
        $name = DatabasenameValue::fromString($value, $this->validator);
    ...
    public function testFromStringThrowExceptionIfValueIsNotValid(): void
    {
        ...
        $this->expectException(NotAValidDatabasenameException::class);
        $this->expectExceptionMessage('string is no valid database name: ' . $value);

        DatabasenameValue::fromString($value, $this->validator);
    }
